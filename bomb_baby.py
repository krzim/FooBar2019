...
But there's a few catches. First, the bombs self-replicate via one of two distinct processes: Every Mach bomb retrieves
a sync unit from a Facula bomb; for every Mach bomb, a Facula bomb is created; Every Facula bomb spontaneously creates
a Mach bomb.
...
need to pass, so the answer would be "1". However, if M = "2" and F = "4", it would not be possible.
